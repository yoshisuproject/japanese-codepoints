...
use crate::data::jisx0208::{
    BOX_DRAWING_CHARS as JISX0208_BOX_DRAWING_CHARS, CYRILLIC_LETTERS as JISX0208_CYRILLIC_LETTERS,
    GREEK_LETTERS as JISX0208_GREEK_LETTERS, HIRAGANA as JISX0208_HIRAGANA,
    KATAKANA as JISX0208_KATAKANA, LATIN_LETTERS as JISX0208_LATIN_LETTERS,
    SPECIAL_CHARS as JISX0208_SPECIAL_CHARS,
};
